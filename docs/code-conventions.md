...
> **Phạm vi:** bản sao trong repo `duck-push`. Bản canon nằm ở gốc workspace `web-game/`.
> **Trạng thái ở repo này:** 🟢 đã áp — xem §8 và ADR-0007
...
| drift | Next | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | `components/` → `views/`; `GameShell` 202 |
| solitaire | Next | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | `components/` → `views/`; **`GameBoard` 562** |
| match | Next | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | `ui/` → `views/`; `Board` 300 |
